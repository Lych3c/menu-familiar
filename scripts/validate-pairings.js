...
['data/base.js','data/v3-init.js','data/v3-breakfasts.js','data/v3-lunches.js','data/v3-dinners.js','data/components.js','data/culinary-extensions.js','data/v4-library.js','data/v4-fixes.js','data/international-recipes.js','data/world-expansion-2.js'].forEach(f=>vm.runInThisContext(fs.readFileSync(f,'utf8'),{filename:f}));
